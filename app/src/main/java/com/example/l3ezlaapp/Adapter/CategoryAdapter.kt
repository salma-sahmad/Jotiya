...
import com.example.l3ezlaapp.Model.CategoryModel
import com.example.l3ezlaapp.R
import com.example.l3ezlaapp.databinding.ViewholderCategoryBinding
...
class CategoryAdapter(val items: MutableList<CategoryModel>) :
    ...
    override fun onBindViewHolder(holder: CategoryAdapter.Viewholder, @SuppressLint("RecyclerView") position: Int) {
        ...
        if (selectedPosition == position) {
            ...
            holder.binding.title.setBackgroundResource(R.drawable.grey_bg)
